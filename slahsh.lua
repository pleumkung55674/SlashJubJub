...
function PleumPleum:Window(text,maincolor)
   ...
   CloseIcon.Image = "http://www.roblox.com/asset/?id=6035047409"
    local function RainbowLoob()  
	    local script = Instance.new('LocalScript', CloseIcon)

	function Rainboweiei(X) return math.acos(math.cos(X*math.pi))/math.pi end
	
	    counter = 0
	
	while wait(0.1)do
		CloseIcon.ImageColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
	
		counter = counter + 0.01
    	end
    end
coroutine.wrap(RainbowLoob)()
   ...
   MinimizeIcon.ImageColor3 = Color3.fromRGB(220, 221, 222)
    local function RainbowLoob()  
	    local script = Instance.new('LocalScript', MinimizeIcon)
	...
	while wait(0.1)do
		MinimizeIcon.ImageColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
...
coroutine.wrap(RainbowLoob)()
   ...
   UserName.Text = "Slash hub"
   UserTag.Text = "Slash Hub"
   local function RainbowLoob()  
	local script = Instance.new('LocalScript', UserTag)
	...
	while wait(0.1)do
		UserTag.TextColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
...
coroutine.wrap(RainbowLoob)()
   ...
   EditBtn.AutoButtonColor = false
    local function RainbowLoob()  
	    local script = Instance.new('LocalScript', EditBtn)
	...
	while wait(0.1)do
		EditBtn.TextColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
...
coroutine.wrap(RainbowLoob)()
   ...
   function ServerHold:Server(text,textgame, img)
    ...
    local function RainbowLoob()  
	   local script = Instance.new('LocalScript', ServerTitle)
	  ...
	  function Rainboweiei(X) return math.acos(math.cos(X*math.pi))/math.pi end
	        ...
	        counter = 0
	            ...
	            while wait(0.1)do
		    ServerTitle.TextColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
    ...
    local function RainbowLoob()  
	    local script = Instance.new('LocalScript', GlowFrame)
	...
	while wait(0.1)do
		GlowFrame.BackgroundColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
...
coroutine.wrap(RainbowLoob)()
	...
	while wait(0.1)do
		Glow.ImageColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
...
coroutine.wrap(RainbowLoob)()
      ...
      Hashtag.TextSize = 25.000
        local function RainbowLoob()  
	    local script = Instance.new('LocalScript', Hashtag)
	...
	while wait(0.1)do
		Hashtag.TextColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
...
coroutine.wrap(RainbowLoob)()
      ...
      ChannelTitle.TextXAlignment = Enum.TextXAlignment.Left
          local function RainbowLoob()  
	    local script = Instance.new('LocalScript', ChannelTitle)
	...
	while wait(0.1)do
		ChannelTitle.TextColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
...
coroutine.wrap(RainbowLoob)()
    ...
    local function RainbowLoob()  
	   local script = Instance.new('LocalScript', GlowChannel)
	...
	while wait(0.1)do
		GlowChannel.ImageColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
...
coroutine.wrap(RainbowLoob)()
      ...
      function ChannelHold:Channel(text)
        ...
        local function RainbowLoob()  
	    local script = Instance.new('LocalScript', ChannelBtnTitle)
	...
	while wait(0.1)do
		ChannelBtnTitle.TextColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
...
coroutine.wrap(RainbowLoob)()
	...
	while wait(0.1)do
		Button.TextColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
	...
	while wait(0.1)do
		ToggleTitle.TextColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
...
coroutine.wrap(RainbowLoob)()
	...
	while wait(0.1)do
		SliderTitle.TextColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
...
coroutine.wrap(RainbowLoob)()
    ...
    local function RainbowLoob()  
	 local script = Instance.new('LocalScript', CurrentValueFrame)
	...
	while wait(0.1)do
		CurrentValueFrame.BackgroundColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
...
coroutine.wrap(RainbowLoob)()
    ...
    local function RainbowLoob()  
	  local script = Instance.new('LocalScript', Zip)
	...
	while wait(0.1)do
		Zip.BackgroundColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
...
coroutine.wrap(RainbowLoob)()
    ...
    local function RainbowLoob()  
	local script = Instance.new('LocalScript', GlowBubble)
	...
	while wait(0.1)do
		   GlowBubble.ImageColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
	...
	while wait(0.1)do
		DropdownTitle.TextColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
...
coroutine.wrap(RainbowLoob)()
    ...
    local function RainbowLoob()  
	  local script = Instance.new('LocalScript', CurrentSelectedText)
	...
	while wait(0.1)do
		CurrentSelectedText.TextColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
...
coroutine.wrap(RainbowLoob)()
        ...
        local function RainbowLoob()  
	    local script = Instance.new('LocalScript', ArrowImg)
	...
	while wait(0.1)do
		ArrowImg.ImageColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
...
coroutine.wrap(RainbowLoob)()
            ...
            for i,v in next, list do
               ...
               ItemText.Text = v
                local function RainbowLoob()  
	    local script = Instance.new('LocalScript', ItemText)
	...
	while wait(0.1)do
		ItemText.TextColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
...
coroutine.wrap(RainbowLoob)()
	...
	while wait(0.1)do
		LabelTitle.TextColor3 = Color3.fromHSV(Rainboweiei(counter),1,1)
